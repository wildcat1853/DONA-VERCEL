    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Service Providers: Trusted third parties who assist in operating our App (e.g., hosting and analytics).</li>
            <li>Legal Authorities: When required by law or to protect our legal rights.</li>
            <li>Third-Party Integrations: With your consent, when connecting to external services (e.g., Google).</li>
          </ul>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">4. Data Retention</h2>
          <p>We retain your information only as long as necessary for the purposes outlined in this policy or as required by law.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>We use industry-standard practices to protect your information. However, no method of transmission over the internet is 100% secure.</p>
        </section>
